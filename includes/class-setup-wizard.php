    ...
    public function save_wizard() {
        ...
        switch ($step) {
            case 'api_key':
                ...
                $model      = sanitize_text_field($_POST['bedrock_model'] ?? 'us.anthropic.claude-sonnet-4-6');
                ...
                <div class="ssf-wizard-panel" id="ssf-step-1">
                    ...
                    <div class="ssf-wizard-field">
                        ...
                        <select id="ssf-wiz-model" class="ssf-wizard-input">
                            <option value="us.anthropic.claude-sonnet-4-6" selected><?php esc_html_e('Claude Sonnet 4.6 (Recommended for SEO)', 'smart-seo-fixer'); ?></option>
                            <option value="us.anthropic.claude-sonnet-4-5"><?php esc_html_e('Claude Sonnet 4.5', 'smart-seo-fixer'); ?></option>
